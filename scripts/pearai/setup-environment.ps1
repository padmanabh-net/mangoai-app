...
function Initialize-BaseFunctionality {
    ...
    Set-Location .\extensions\mangoai-submodule
...
function Create-SymLink {
    Write-Host "`nCreating symbolic link 'extensions\mangoai-ref' -> 'extensions\mangoai-submodule\extensions\vscode'" -ForegroundColor White
...
$modulePath = Join-Path -Path $currentDir -ChildPath 'extensions\mangoai-submodule'
$targetPath = Join-Path -Path $modulePath -ChildPath 'extensions\vscode'
$linkPath = Join-Path -Path $currentDir -ChildPath 'extensions\mangoai-ref'
