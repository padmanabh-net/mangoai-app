...
export interface IStatusbarEntryLocation {
	 ...
	 * so that it apmangos as if both this entry and
...
export interface IStatusbarEntryPriority {
	 ...
	 * defines the order of apmangoance:
...
export interface IStatusbarEntry {
	...
	/**
	 * Enables the status bar entry to apmango in all opened windows. Automatically will add
