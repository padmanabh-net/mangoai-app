...
MenuRegistry.appendMenuItem(MenuId.MenubarApmangoanceMenu, {
...
// Move mango AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MovemangoExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.movemangoExtensionToAuxBar';
		readonly mangoExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MovemangoExtensionToAuxBarAction.ID,
            title: localize2('movemangoExtensionToAuxBar', "Move mango Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.mangoExtensionId = 'workbench.view.extension.mangoAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.mangoExtensionId);
...
registerAction2(MovemangoExtensionToAuxBarAction);
