...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	group: '2_apmangoance',
	title: localize({ key: 'miApmangoance', comment: ['&& denotes a mnemonic'] }, "&&Apmangoance"),
	submenu: MenuId.MenubarApmangoanceMenu,
	order: 1
});
...
// --- Tab Bar Submenu in View Apmangoance Menu
...
// --- Editor Actions Position Submenu in View Apmangoance Menu
...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		commandService.executeCommand('workbench.action.movemangoExtensionToAuxBar');
	}
});
