...
// Todo: Replace this with mangoAI logo (https://github.com/trymango/mangoai-app/issues/235)
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get Started With mangoAI"),
		description: localize('gettingStarted.setup.description', "Welcome to mangoAI, your AI code editor! Let's personalize your editor and get you familiar with the AI tools."),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		next: 'Beginner',
