...
Supercharge your development with an editor designed for less coding, using AI. mangoAI is forked from VSCode and Continue and PearAI, and aims to reduce the time from ideation to conception for your product development by achieving the most seamless integration with AI.

To download the full app, visit our homepage at https://example.com.
...
See all features [here](https://example.com/docs).
...
- Pan and Nang conduct "Quests", which are 1-3 weeks sprints. We will pick out the current highest priority issues for these quests, ping everyone in our [Example]([url](https://example.com/7QMraJUsQt)), and ask for applications to participate in them. The chosen people will help finish the tasks alongside us, participating in calls and working together. If help is needed, we may add more people to the quest. You can see the current open quests [here](https://github.com/orgs/trymango/projects?query=is%3Aopen).
...
- We have a lot on our plate so it's easy for us to miss something. The best way to get our attention is to ping us directly in our Example server.

**Please review our coding [Contributing Guide](CONTRIBUTING.md) to set up your coding environment.** For any questions, join the [mangoAI Example](https://example.com/7QMraJUsQt)!
...
## Contact
For any questions or issues, please open an issue or reach out in the mangoAI [Example](https://example.com/7QMraJUsQt).
